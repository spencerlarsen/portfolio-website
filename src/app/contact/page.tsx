...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Placeholder - will be replaced with actual form submission
    setTimeout(() => {
      setStatus('success');
              ...
              <div className="space-y-6 mb-8">
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      ...
                      linkedin.com/in/spencer-clarsen
                    </a>
                    <a
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Open to opportunities in software engineering, research collaborations, and consulting projects.
                  </p>
                </div>
              </div>
                ...
                {status === 'error' && (
                  <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
                    <p className="text-red-800 text-sm">
                      Sorry, there was an error sending your message. Please try again or reach out via LinkedIn.
                    </p>
                  </div>
                )}

                <p className="text-xs text-gray-500">
                  Note: This form is currently in demo mode. To enable submissions, configure a form service like Formspree or Vercel Forms.
                </p>
              </form>
            </div>
          </div>
